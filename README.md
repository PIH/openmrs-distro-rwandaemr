...
shown here, the distribution identifier is:  `org.pih.openmrs:rwinkwavu-distro:4.0.0-SNAPSHOT`
...
```mvn openmrs-sdk:setup -DserverId=rwinktest -Ddistro=org.pih.openmrs:rwinkwavu-distro:4.0.0-SNAPSHOT```
